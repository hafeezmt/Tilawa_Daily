...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-2xl bg-midnight-950/85 border-b border-white/15 px-4 sm:px-6 lg:px-8 py-3 transition-all shadow-md">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              <span className="relative flex h-2.5 w-2.5">
                ...
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-emerald-500 shadow-emerald-glow"></span>
              </span>
            </div>
        ...
        <nav className="hidden md:flex items-center p-1.5 rounded-2xl bg-midnight-900/90 border border-white/15 shadow-inner">
          <button
          ...
          >
            <Radio className={`w-3.5 h-3.5 ${activeTab === 'halaqah' ? 'text-midnight-950' : 'text-emerald-400 animate-pulse'}`} />
          ...
          >
            <CheckCircle2 className={`w-3.5 h-3.5 ${activeTab === 'tracker' ? 'text-midnight-950' : 'text-celestial-400'}`} />
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {isAdmin && (
            ...
            >
              ...
              {pendingMembers.length > 0 && (
                <span className="px-2 py-0.5 rounded-full bg-amber-500 text-midnight-950 text-[10px] font-black animate-pulse shadow-sm">
          ...
          <button
            ...
            className="p-2.5 rounded-xl glass-card border border-white/15 text-slate-200 hover:text-gold-300 hover:border-gold-500/50 transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="p-2.5 rounded-xl glass-card border border-white/15 text-slate-200 hover:text-celestial-300 hover:border-celestial-500/50 transition-all shadow-sm"
          >
      ...
      <div className="flex md:hidden items-center p-1 rounded-2xl bg-midnight-900/90 border border-white/15 mt-2.5 shadow-inner">
        <button
          onClick={() => setActiveTab('halaqah')}
